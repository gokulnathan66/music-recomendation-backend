...
#     Returns:
#         Optional[str]: The lyrics of the song as a string if found, otherwise None or otherwise an exception message.
...
#     params = {"q": song_name}
#     print("get_lyrics_textly called")

#     try:
#         response = requests.get(url, params=params, verify=False)
#         response.raise_for_status()  # Raise an error for HTTP error codes
#         json_response = response.json()
#         return json_response  # Returning the full JSON response
